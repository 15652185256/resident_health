...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, WIDTH, datePicker.frame.size.height);
...
-(UIToolbar *)setToolbarStyle{
    ...
    toolbar.items=@[centerSpace,lefttem,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,centerSpace,right,centerSpace];
    return toolbar;
}
