...
//- (void)setPrecent:(int)precent description:(NSString *)description textColor:(UIColor *)tcolor DescTextColor:(UIColor*)dcolor bgColor:(UIColor *)bColor alpha:(CGFloat)alpha clips:(BOOL)clips;
