...
{
    [self.waveView setPrecent:precent description:description descText:dtext descType:dtype textColor:tcolor DescTextColor:dcolor bgColor:bColor alpha:alpha clips:clips];
    self.waveView.half = YES;
}
