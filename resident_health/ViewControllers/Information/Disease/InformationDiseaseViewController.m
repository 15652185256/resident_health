//
//  InformationDiseaseViewController.m
//  resident_health
//
...
#import "InformationDiseaseViewController.h"
...
@interface InformationDiseaseViewController ()
//总视图
...
@implementation InformationDiseaseViewController
...
-(void)createView
{
    ...
    NSArray * buttonImageNames = @[@"tang_niao_bing@2x",@"gao_xue_ya@2x",@"guan_xin_bing@2x",@"gao_zhi_xue_zheng@2x",@"gu_zhi_su_song@2x",@"zhi_fang_gan@2x",@"qian_lie_xian_zeng_sheng@2x",@"man_zu_fei@2x",@"zhong_feng@2x",@"tong_feng@2x"];
    
    NSArray * buttonTitles = @[@"糖尿病",@"高血压",@"冠心病",@"高脂血症",@"骨质疏松",@"脂肪肝",@"前列腺增生",@"慢阻肺",@"中风",@"痛风"];
